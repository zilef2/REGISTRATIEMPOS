<script setup>
    ...
    import {PrimerasPalabras,formatDate} from '@/global.js';
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr 
                                ...
                                <td class="whitespace-nowrap py-4 px-2 sm:py-3">{{ formatDate(props.fromController.Fecha_creacion_parametro,false) }} </td>
                                <td class="whitespace-nowrap py-4 px-2 sm:py-3">{{ PrimerasPalabras(props.fromController.nombre,20) }} </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
